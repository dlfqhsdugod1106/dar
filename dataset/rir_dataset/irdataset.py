...
from dataset.rir_dataset.augment import augment
...
class IRDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        data, sr = sf.read(self.ir_directory_list[idx % len(self.ir_directory_list)])#self.aug_const])
...
def ALTI_SPLIT(directory = '/SSD/RIR/altiverb-ir', split_ratio = (.6, .2), aug_const = 3):
    ...
    train_alti = IRDataset(train_directory_list, aug_const = aug_const, aug = True)
    vali_alti = IRDataset(vali_directory_list, aug_const = aug_const, aug = False)
    test_alti = IRDataset(test_directory_list, aug_const = aug_const, aug = False)
...
def OPENAIR_SPLIT(directory = '/SSD/RIR/OpenAIR', split_ratio = (.6, .2), aug_const = 10):
    ...
    train_openair = IRDataset(train_directory_list, aug_const = aug_const, aug = True)
    vali_openair = IRDataset(vali_directory_list, aug_const = aug_const, aug = False)
    test_openair = IRDataset(test_directory_list, aug_const = aug_const, aug = False)
