...
def Generate_Dataset(ir_len = 2, noiseir_ratio = .3):
    ...
    train_pyroom = PyRoom3(train_speech, ir_len = ir_len, noiseir_ratio = noiseir_ratio)
...
class IRDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        """ SPEECH """
        speech_idx = 0#random.randint(0, self.speech_dataset_len - 1)
        speech, speech_sr = sf.read(self.speech_directory_list[speech_idx])
